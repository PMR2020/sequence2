package com.example.myapplicationtp1.data
...
object DataProvider {
    ...
    suspend fun setItem(hash: String, listId: Int, itemId: Int, checked: Boolean) = service.setItem(listId, itemId, if (checked) 1 else 0, hash)
